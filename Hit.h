  ...
  public:
    ...
    void SetDataType(unsigned int type, std::string dppType){
      ...
      if( dataType == DataFormat::Raw){
        ...
        analog_probes[0] = new int32_t[MaxtraceLength];
        analog_probes[1] = new int32_t[MaxtraceLength];

        digital_probes[0] = new uint8_t[MaxtraceLength];
        digital_probes[1] = new uint8_t[MaxtraceLength];
        digital_probes[2] = new uint8_t[MaxtraceLength];
        digital_probes[3] = new uint8_t[MaxtraceLength];
    ...
    void PrintEnergyTimeStamp(){
      printf("ch: %2d, energy: %u, timestamp: %lu ch, traceLength: %lu\n", channel, energy, timestamp, traceLength);
    }
    ...
    void PrintAll(){
      ...
      printf("flag (high): 0x%02X, (low): 0x%03X, traceLength: %lu\n", flags_high_priority, flags_low_priority, traceLength);
    ...
    void PrintTrace(unsigned short ID){
      for(unsigned short i = 0; i < (unsigned short)traceLength; i++){
